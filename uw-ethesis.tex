...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=80mm]{../Desktop/figures/perceptron.PNG}
	...
	\begin{algorithm}
		...
		\begin{algorithmic}[1]
			...
			\If {$f(\mathbf{w} + \mathbf{p}_{1}) > f(\mathbf{w} + \mathbf{p}_{0})$}
			\State $\mathbf{p}^{*} \gets \mathbf{p}_{0}$
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=0.6\linewidth]{MNIST_SMBGDGD.png}
	...
	\begin{algorithm}
		...
		\begin{algorithmic}[1]
			\Function{$\gamma = $ updateGamma($a$, $r$, $e_{c}$, $e_{c-1}$ and $\gamma$)}{}
	...
	\begin{algorithm}
		...
		\begin{algorithmic}[1]
			\Function{$\eta = $ checkProgress($a$, $r$, $e_{c}$, $e_{c-1}$ and $\eta$)}{}		
			\If{$r$ mod $a == 0$}
			\If{$e_{c} > e_{c-1} + tol$}
	...
	\begin{figure}
		...
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Derm_TRMMBGD2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{IRIS_TRMMBGD2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Habe_TRMMBGD2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Nurs_TRMMBGD2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{MNIST_TRMMBGD2.png}
		\end{subfigure}
	...
	\begin{figure}
		\centering
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Derm_SMBTRMTRM.png}
		\end{subfigure}%
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{IRIS_SMBTRMTRM.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Habe_SMBTRMTRM.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Nurs_SMBTRMTRM.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{MNIST_SMBTRMTRM.png}
		\end{subfigure}
	...
	\begin{figure}
		\centering
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/Derm_BTRMTRM.png}
		\end{subfigure}%
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/IRIS_BTRMTRM.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/Habe_BTRMTRM.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/Nurs_BTRMTRM.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/MNIST_BTRMTRM.png}
		\end{subfigure}
	...
	\begin{figure}
		\centering
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Derm_TRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{IRIS_TRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Habe_TRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Nurs_TRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{MNIST_TRMWS.png}
		\end{subfigure}
	...
	\begin{figure}
		\centering
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/Derm_BTRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/IRIS_BTRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/Habe_BTRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/Nurs_BTRMWS.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{../Desktop/figures/MNIST_BTRMWS.png}
		\end{subfigure}
	...
	\begin{figure}
		\centering
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Derm_SMBTRMWS2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{IRIS_SMBTRMWS2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Habe_SMBTRMWS2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{Nurs_SMBTRMWS2.png}
		\end{subfigure}
		\begin{subfigure}{.45\textwidth}
			\includegraphics[width=\textwidth]{MNIST_SMBTRMWS2.png}
		\end{subfigure}
...
\end{figure}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=\linewidth]{../Desktop/figures/XOR_robustness_time2.PNG}
